...
const portfolioItems: PortfolioItem[] = [
    // 오리지널 및 개인 프로젝트
    { id: 49, category: '오리지널 및 개인 프로젝트', image: 'https://picsum.photos/seed/oproj8/500/500', title: '【독쥐】\'Promise Way\' Official MV (concert ver)', role: 'Original Song', date: '2024', youtubeId: 'Q8xux7o2V5M' },
    ...
    // 보컬 디렉팅 및 믹스마스터링
    { id: 50, category: '보컬 디렉팅 및 믹스마스터링', image: 'https://picsum.photos/seed/vdmix10/500/500', title: '【독쥐】윤하 - 오르트구름 COVER', role: 'Vocal Mix/Master', date: '2024', youtubeId: 'VjQF5pyAMzM' },
    { id: 51, category: '보컬 디렉팅 및 믹스마스터링', image: 'https://picsum.photos/seed/vdmix11/500/500', title: '【독쥐】경서 - 밤하늘의 별을 COVER', role: 'Vocal Mix/Master', date: '2024', youtubeId: '4QoHyyEGZBo' },
    { id: 52, category: '보컬 디렉팅 및 믹스마스터링', image: 'https://picsum.photos/seed/vdmix12/500/500', title: '【독쥐】음율 - 파도혁명 COVER', role: 'Vocal Mix/Master', date: '2024', youtubeId: 'ZFjayCtoqV8' },
    ...
    { id: 43, category: '라이브 사운드 오퍼레이팅', image: 'https://picsum.photos/seed/live_mc1/500/500', title: '이오몽 X 조매력 모션캡쳐 스튜디오 라이브 음향 오퍼레이팅', role: 'Studio Sound Operating', date: '2024', youtubeId: 'QX77TyiXYAE' },
            ...
            cards: [
                {
                    ...
                    features: [
                        ...
                        '오리지널 곡: ₩490,000~ ~~₩700,000~~',
                        '오리지널 곡 (탑라인 X): ₩280,000~ ~~₩400,000~~',
                        '상업용 BGM 및 사운드 디자인: ₩560,000~ ~~₩800,000~~',
                    ],
                ...
                },
                {
                    title: '믹스 & 마스터링',
                    features: [
                        '솔로곡 풀믹스: ₩49,000 ~~₩75,000~~',
                        '듀엣곡 풀믹스: ₩70,000 ~~₩108,000~~',
                        '믹스마스터 only: ₩21,000 ~~₩32,000~~',
                        '1절치기 믹스: ₩35,000 ~~₩54,000~~',
                        '음정/박자보정(추가 1인당): +₩20,000 ~~+₩31,000~~',
                        '빠른 마감 (3일 이내): +₩50,000 ~~+₩77,000~~',
                        '당일 마감: +₩70,000 ~~+₩108,000~~',
                    ],
                    note: '',
                },
                {
                    title: '방송 & 음향 세팅',
                    features: [
                        '온라인 DAW/OBS 지원: ₩50,000 ~~₩77,000~~',
                        '오디오 장비 세팅: ₩70,000 ~~₩108,000~~',
                        '현장출장 및 오디오 오퍼레이팅 출장: ₩150,000 ~~₩231,000~~',
                    ],
            ...
            cards: [
                {
                    ...
                    features: [
                        ...
                        'Original Song: ₩490,000~ ~~₩700,000~~',
                        'Original Song (No Topline): ₩280,000~ ~~₩400,000~~',
                        'Commercial BGM & Sound Design: ₩560,000~ ~~₩800,000~~',
                    ],
                ...
                },
                {
                    title: 'Mix & Mastering',
                    features: [
                        'Solo Full Mix: ₩49,000 ~~₩75,000~~',
                        'Duet Full Mix: ₩70,000 ~~₩108,000~~',
                        'Mix/Master Only: ₩21,000 ~~₩32,000~~',
                        '1 Verse Mix: ₩35,000 ~~₩54,000~~',
                        'Pitch/Time Correction (per person): +₩20,000 ~~+₩31,000~~',
                        'Rush Fee (within 3 days): +₩50,000 ~~+₩77,000~~',
                        'Same Day Delivery: +₩70,000 ~~+₩108,000~~',
                    ],
                    note: '',
                },
                {
                    ...
                    features: [
                        'Online DAW/OBS Support: ₩50,000 ~~₩77,000~~',
                        'Audio Gear Setup: ₩70,000 ~~₩108,000~~',
                        'On-site Support & Audio Operating: ₩150,000 ~~₩231,000~~',
                    ],
